...
fn sha3_compress_block(ctx: *Sha3Ctx) void {
    ...
    inline for (0..Sha3Ctx.MESSAGE_SCHEDULE_WORDS) |t| {
        const tmp1 = h +% sha3_Sigma_512_1(e) +% sha.ch(Sha3Ctx.WordType, e, f, g) +% SHA3_K_512[t] +% message_schedule[t];
        const tmp2 = sha3_Sigma_512_0(a) +% sha.maj(Sha3Ctx.WordType, a, b, c);
        h = g;
        g = f;
        f = e;
        e = d +% tmp1;
...
pub fn sha384_final(ctx: *Sha3Ctx, out: *[SHA_384_DIGEST_LENGTH]u8) void {
    ...
    return sha3_final(ctx, SHA_384_DIGEST_LENGTH, out);
}
...
pub fn sha512_224_final(ctx: *Sha3Ctx, out: *[SHA_512_224_DIGEST_LENGTH]u8) void {
    ...
    return sha3_final(ctx, SHA_512_224_DIGEST_LENGTH, out);
}
...
pub fn sha512_256_final(ctx: *Sha3Ctx, out: *[SHA_512_256_DIGEST_LENGTH]u8) void {
    ...
    return sha3_final(ctx, SHA_512_256_DIGEST_LENGTH, out);
}
...
test "SHA-512/224 basic test" {
    try sha.run_hash_precomputed_tests(
        ...
        sha512_224_final,
        &.{
            .{ .message = "", .hash = "6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7" },
            .{ .message = "abc", .hash = "e642824c3f8cf24ad09234ee7d3c766fc9a3a5168d0c94ad73b46fdf" },
            .{
                .message = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
                .hash = "8a24108b154ada21c9fd5574494479ba5c7e7ab76ef264ead0fcce33",
            },
            .{
                .message = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
...
test "SHA-512/256 basic test" {
    try sha.run_hash_precomputed_tests(
        ...
        sha512_256_final,
        &.{
            .{ .message = "", .hash = "a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a" },
            .{ .message = "abc", .hash = "3a985da74fe225b2045c172d6bd390bd855f086e3e9d525b46bfe24511431532" },
            .{
                .message = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
                .hash = "41c0dba2a9d6240849100376a8235e2c82e1b9998a999e21db32dd97496d3376",
            },
            .{
                .message = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
